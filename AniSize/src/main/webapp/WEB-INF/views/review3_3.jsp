    ...
    <style>
      ...
      .re-btn {
        ...
        font-size: .9em;
            ...
            .review-check2 .n-radio-tab2 input + label{
              width: 59px;
              height: 32px;
              padding-top: 2px;
              margin-right: 0;
            ...
            .n-radio-tab2 input:nth-child(4) + label {
            border-radius: 4px 0 0 4px;
             }
             .review-check2 .n-radio-tab2 input + label:last-child {
               border-right: 1px solid #ebebeb;
               border-radius: 0 4px 4px 0;
             }
             .review-check2 .n-radio-tab2 input:checked + label:last-child{
              border-right: 1px solid #0078ff
             }

             .review-check2 .n-radio-tab2 input:checked + label{
              border: 1px solid #0078ff;
              color: #fff;
              background: #0078ff;
              border-right: 0;
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-11">
          <h3 style="margin-right: 50px; margin-top: 0px">사이즈 추천</h3>
        </div>
      </div>
